...
function getDays(t: ReturnType<typeof useT>) {
  // Left to Right: الإثنين, الثلاثاء, الأربعاء, الخميس, الجمعة, السبت, الأحد
  // In RTL the array is reversed so الإثنين appears on the LEFT
  return [
        ...
        {loading ? (
          ...
          <div className="rounded-xl border shadow-sm bg-card text-card-foreground">
              ...
              <div
                ...
                style={{ position: 'sticky', top: '60px', zIndex: 20, height: '44px', backgroundColor: '#ffffff' }}
              >
                    {/* Day column headers */}
                    {days.map((day) => {
